...
class ShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create show" do
    assert_difference('Show.count') do
      post shows_url, params: { show: { genre: @show.genre, movie: @show.movie, site: @show.site } }
    end
  ...
  test "should update show" do
    patch show_url(@show), params: { show: { genre: @show.genre, movie: @show.movie, site: @show.site } }
